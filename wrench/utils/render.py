...
class Rendering:
	def __init__(self, success, title, is_parent, args, kwargs):
		...
		self.dynamic_feed = wrench.cli.from_command_line and wrench.cli.dynamic_feed
...
def job(title: str = None, success: str = None):
	...
	For instance, the `get-app` command consists of two jobs: `initializing wrench`
