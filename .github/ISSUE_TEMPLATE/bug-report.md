---
name: Bug report
about: Report a bug encountered while using wrench
labels: bug
---

Issue: Bug report

Please make sure your issue is reproducible on the latest wrench version. The currently supported branches are:
 - PyPI [latest](https://pypi.org/project/saashq-wrench/) 
 - master         (minor bug fixes)
 - v5.x           (Merged with develop on every release)
 - develop        (all updates)

**Do the checklist before filing an issue:**
 - [ ] Can you replicate the issue on the supported wrench versions?
...
Can be found out by running `wrench version` in your respective wrench folder.
- Wrench Branch:
- Saashq Version:
- ERPNexus Version:
